        ...
        {highlights.map((highlight, index) => {
          ...
          return (
            <CardWrapper
              key={highlight.id}
              {...cardProps}
              className={`group relative rounded-lg overflow-hidden shadow-md hover:shadow-xl transition-all bg-white dark:bg-gray-700 border border-gray-200 dark:border-gray-600 ${
            ...
            >
              ...
              <div className="p-4">
                ...
                {highlight.url && (
                  <span
                    className="inline-flex items-center gap-1 text-sm font-medium group-hover:underline"
                    style={{
